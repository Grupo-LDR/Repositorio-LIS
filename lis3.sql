...
-- Tiempo de generación: 03-10-2023 a las 14:24:15
...
--
-- Estructura de tabla para la tabla `user_empleado`
--
...
CREATE TABLE IF NOT EXISTS `user_empleado` (
  ...
  `id_user_tipo` tinyint UNSIGNED NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS `user_tipo`;
