...
-- Tiempo de generación: 11-10-2023 a las 12:43:04
...
CREATE TABLE IF NOT EXISTS `audit_orders` (
  ...
  PRIMARY KEY (`id`,`users_id`,`orders_id`,`action_records_id`),
...
DROP TABLE IF EXISTS `medical_conditions_has_users`;
CREATE TABLE IF NOT EXISTS `medical_conditions_has_users` (
  `medical_conditions_id` int UNSIGNED NOT NULL,
  `users_id` int UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `studies` (
  ...
  PRIMARY KEY (`id`,`orders_id`,`studie_results_id`,`tests_id`),
...
CREATE TABLE IF NOT EXISTS `tests` (
  ...
  `samples_id` int UNSIGNED NOT NULL,
...
DROP TABLE IF EXISTS `tests_determination`;
CREATE TABLE IF NOT EXISTS `tests_determination` (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `citys_id` int UNSIGNED NOT NULL,
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `gender`, `active`, `document`, `phone`, `email`, `address`, `date_birth_at`, `password`, `date_create_at`, `create_users_id`, `date_update_at`, `update_users_id`, `citys_id`) VALUES
(1, 'Rafael', 'Lopez', 'M', 1, 18364223, 555555, 'lopezrafa@gmail.com', 'mod 5 casa 6', '1967-10-23', '', '2023-10-11 09:30:18', 0, '2023-10-11 12:22:42', 0, 145);
COMMIT;
